...
Your turn: adjust the system prompt to the model so that, when supplied a question like "What's 2+2?", the model returns _only_ the answer, no punctuation or exposition.
